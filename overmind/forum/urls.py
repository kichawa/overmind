...
urlpatterns = patterns('forum.views',
    ...
    url(r'^topic/(?P<topic_pk>\d+)/(?:([^/]+)/)?toggle-close/$',
        'topic_toggle_close',
        name="topic-toggle-close"),
    ...
    url(r'^topic/(?P<topic_pk>\d+)/post/(?P<post_pk>\d+)/toggle-is-solving/$',
        'post_toggle_is_solving',
        name="post-toggle-is-solving"),
